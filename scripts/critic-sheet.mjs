...
const KEST = (a) => `
  <header class="masthead">
    ...
    <p class="note">
      Skaala on 1–10, ainult täisnumbrid. Enter viib järgmisse lahtrisse.
    </p>
    <p class="note">
      <b>Tühi lahter on normaalne.</b> Nõunikud vahetuvad: tavaliselt hindavad
      kaks püsikriitikut ja külaline, mitte kõik veerus olijad. Raul Saaremets
      on enamasti ainult saatejuht ega anna punkte — tema hindab ise vaid
      erisaadetes ja aastakokkuvõtetes. Jäta tühjaks igaüks, kes ei osalenud
      või kelle hinne jäi kuulmata; keskmine arvestab ainult täidetud lahtreid.
    </p>
